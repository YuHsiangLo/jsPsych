jsPsych.plugins['fixation-click'] = (function() {
    const plugin = {};
    ...
    plugin.trial = function(display_element, trial) {
        ...
        fixation_point.style.top = (trial.zone_height/2 - trial.y_pos - trial.fixation_radius) + 'px';
        fixation_point.style.left = (trial.zone_width/2 + trial.x_pos - trial.fixation_radius) + 'px';
